...
if __name__ == "__main__":
    ...
    if isUploadIPA == True:
        strCmd = "/Applications/Xcode.app/Contents/Applications/Application\ Loader.app/Contents/Frameworks/ITunesSoftwareService.framework/Versions/A/Support/altool --upload-app -f "+ipa_file+"/"+target+".ipa"+" -t ios -u chyfemail163@163.com -p ayww-hcnh-uaau-lsgh"
        os.system(strCmd)
    else:
        # build target.app
